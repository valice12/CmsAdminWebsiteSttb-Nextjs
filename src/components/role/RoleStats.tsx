...
export function RoleStats({ rolesCount, permissionsCount }: RoleStatsProps) {
  const stats = [
    { label: 'Registered Roles', value: rolesCount, icon: Shield, color: 'text-indigo-600', bgColor: 'bg-indigo-50' },
    { label: 'Access Keys', value: permissionsCount, icon: Lock, color: 'text-amber-500', bgColor: 'bg-amber-50' },
