...
export function KegiatanForm({ id }: KegiatanFormProps) {
  ...
  useEffect(() => {
    async function loadCategories() {
      try {
        const data = await getAllEventCategories(1, 10, true);
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-[2rem] p-8 shadow-xl shadow-gray-200/50 border border-gray-100 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`pl-12 h-14 rounded-2xl text-lg font-bold transition-all shadow-inner border-2 ${form.formState.errors?.eventTitle
            ...
            <div className="space-y-2">
              ...
              <div className={`relative rounded-2xl overflow-hidden shadow-inner transition-all border-2 ${form.formState.errors?.description
                  ? 'border-red-500 bg-red-50/50'
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`pl-12 h-12 rounded-xl text-sm font-bold transition-all shadow-inner border-2 ${form.formState.errors?.organizerName
                        ? 'border-red-500 bg-red-50/50'
                        : 'bg-gray-50/50 border-transparent focus:bg-white'
                      }`}
                  />
