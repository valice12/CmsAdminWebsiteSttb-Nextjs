...
import { Newspaper, AlertCircle, Plus, Search } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex flex-col gap-1 text-left">
          ...
          <p className="text-muted-foreground font-medium text-sm">
            Manajemen kategori untuk mengelompokkan berita.
          </p>
        </div>
      ...
      <div className="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 p-20 flex flex-col items-center justify-center text-center space-y-6">
        <div className="w-24 h-24 bg-amber-50 rounded-3xl flex items-center justify-center">
          <AlertCircle className="w-12 h-12 text-amber-500" />
        </div>
        <div className="max-w-md space-y-2">
          <h2 className="text-2xl font-black text-gray-900">Segera Hadir</h2>
          <p className="text-gray-500 font-medium">
            Halaman manajemen kategori berita sedang dalam tahap pengembangan. Fitur ini akan menghubungkan kategori dengan modul filter di sisi frontend.
          </p>
        </div>
