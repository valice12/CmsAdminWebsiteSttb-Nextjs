...
import { Calendar, AlertCircle, Plus, Search } from 'lucide-react';
    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex flex-col gap-1 text-left">
          ...
          <p className="text-muted-foreground font-medium text-sm">
            Manajemen kategori untuk mengelompokkan kegiatan akademik dan non-akademik.
          </p>
        </div>
      ...
      <div className="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 p-20 flex flex-col items-center justify-center text-center space-y-6">
        ...
        <div className="max-w-md space-y-2">
          <h2 className="text-2xl font-black text-gray-900">Persiapan Backend</h2>
          <p className="text-gray-500 font-medium">
            Halaman manajemen kategori kegiatan sedang menunggu ketersediaan endpoint API. Struktur data akan disesuaikan dengan skema Manajemen Event STTB Bandung.
          </p>
        </div>
